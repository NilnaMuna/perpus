...
if (strlen($tambah) == 1) {
    ...
    $format = "B"."0".$tambah;
} else { // ini otomatis untuk strlen == 3
    $format = "B".$tambah;
}
?>
...
//         $sql_simpan = "INSERT INTO tb_buku (id_buku,judul_buku,jenis_buku,pengarang,penerbit,th_terbit) VALUES (
//            '".$_POST['id_buku']."',
//           '".$_POST['judul_buku']."',
// 		  '".$_POST['jenis_buku']."',
//           '".$_POST['pengarang']."',
...
if (isset($_POST['Simpan'])) {
  $sql_simpan = "INSERT INTO tb_buku 
    (id_buku, judul_buku, jenis_buku, pengarang, penerbit, th_terbit, stok) 
    VALUES (
      '".$_POST['id_buku']."',
      '".$_POST['judul_buku']."',
      '".$_POST['jenis_buku']."',
  ...
  if ($query_simpan) {
    ...
    echo "<meta http-equiv='refresh' content='0; url=?page=MyApp/data_buku'>";
  } else {
